...
Item {
    ...
    Loader {
        active: root.fill
        anchors.fill: parent
        sourceComponent: Rectangle { radius: 9999; color: root.colSecondary }
    }
    ...
    Shape {
        ...
        ShapePath {
            strokeColor: root.colSecondary; strokeWidth: root.lineWidth
        ...
        ShapePath {
            strokeColor: root.colPrimary; strokeWidth: root.lineWidth
            capStyle: ShapePath.RoundCap; fillColor: "transparent"
            PathAngleArc {
                centerX: root.centerX; centerY: root.centerY
                radiusX: root.arcRadius; radiusY: root.arcRadius
                startAngle: root.startAngle; sweepAngle: root.degree
            }
        }
    }
}
