...
Singleton {
    ...
    ColorQuantizer {
        ...
        property bool wallpaperIsVideo: FileUtils.isVideo(wallpaperPath)
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // Material Design 3 Color Tokens (defaults — overridden by MaterialThemeLoader)
    // ═══════════════════════════════════════════════════════════════════════
    m3colors: QtObject {
        property bool darkmode: Config?.options.appearance.colors.darkMode ?? true
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // Layered Color System (L0-L4 with hover/active states)
    // ═══════════════════════════════════════════════════════════════════════
    colors: QtObject {
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // Animation Curves (Material Design 3 expressive motion)
    // ═══════════════════════════════════════════════════════════════════════
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // Animation Presets (ready-to-use animation configs with speed multiplier)
    // ═══════════════════════════════════════════════════════════════════════
    readonly property real animSpeedMultiplier: Config?.options.animations.enabled ? (Config?.options.animations.speedMultiplier ?? 1.0) : 0.001

    animation: QtObject {
        property QtObject elementMove: QtObject {
            property int duration: animationCurves.expressiveDefaultSpatialDuration * root.animSpeedMultiplier
        ...
        property QtObject elementMoveEnter: QtObject {
            property int duration: 400 * root.animSpeedMultiplier
            property int type: Easing.BezierSpline
        ...
        property QtObject elementMoveExit: QtObject {
            property int duration: 200 * root.animSpeedMultiplier
            property int type: Easing.BezierSpline
        ...
        property QtObject elementMoveFast: QtObject {
            property int duration: animationCurves.expressiveEffectsDuration * root.animSpeedMultiplier
            property int type: Easing.BezierSpline
        ...
        property QtObject elementResize: QtObject {
            property int duration: 300 * root.animSpeedMultiplier
            property int type: Easing.BezierSpline
        ...
        property QtObject menuDecel: QtObject {
            property int duration: 350 * root.animSpeedMultiplier
            property int type: Easing.OutExpo
        }
    }

    // ═══════════════════════════════════════════════════════════════════════
    // Sizes (layout constants, bezel-aware)
    // ═══════════════════════════════════════════════════════════════════════
    sizes: QtObject {
        // Global bezel (gap from screen edges for ALL elements)
        property real bezel: Config.options.appearance.bezel

        property real baseBarHeight: 40
        property real barHeight: Config.options.bar.cornerStyle === 1 ?
            (baseBarHeight + bezel * 2) : baseBarHeight
        ...
        property real verticalBarWidth: Config.options.bar.cornerStyle === 1 ?
            (baseVerticalBarWidth + bezel * 2) : baseVerticalBarWidth
